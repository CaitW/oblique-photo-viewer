    ...
    render() {
        return (
        	<Col xs={12} sm={7} md={8} lg={9} className="map-container">
				<FeatureModal visible={this.props.featureModal.visible} featureProperties={this.props.featureModal.featureProperties} featureType={this.props.featureModal.featureType} onCloseClick={this.closeFeatureModal}/>
				<LeafletMap />
			</Col>
		);
    }
